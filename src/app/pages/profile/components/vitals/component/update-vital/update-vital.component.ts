...
import { VisitVitalUpdateModel } from '../../model';
import { VisitVitalService } from '../../service';
...
export class UpdateVitalComponent implements OnInit {
    ...
    onChangeDate = async (value) => {
        if (!value) return;
        const res = await this.visitVitalService.listResultTime(this.ResultDate.Date, this.data);
